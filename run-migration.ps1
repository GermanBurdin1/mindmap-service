# run-migration.ps1
# Скрипт для выполнения миграций в mindmap-service
...
Write-Host "Database Migrations for mindmap-service" -ForegroundColor Cyan

if (!(Test-Path "package.json")) {
    Write-Host "Error: package.json not found. Make sure you are in mindmap-service directory" -ForegroundColor Red
    exit 1
}
